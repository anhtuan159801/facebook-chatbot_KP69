#!/usr/bin/env python3
"""
Test script to verify chunking functionality in the RAG system
"""
...
# Add the Knowlegd-rag directory to the path
knowledge_rag_path = os.path.join(os.path.dirname(__file__), 'Knowlegd-rag')

# Import content_processor module
content_processor_spec = importlib.util.spec_from_file_location("content_processor",
    os.path.join(knowledge_rag_path, "content_processor.py"))
content_processor = importlib.util.module_from_spec(content_processor_spec)
content_processor_spec.loader.exec_module(content_processor)

# Import vector_storage module
...
ContentProcessor = content_processor.ContentProcessor
ContentExtractionResult = content_processor.ContentExtractionResult
ChunkingResult = content_processor.ChunkingResult
